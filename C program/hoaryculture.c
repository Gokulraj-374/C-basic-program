...
Write a program to help him to find final position of a person.
*/
#include <stdio.h>
int main(){
	...
	for (int i = 1; i<=n; i++){
		switch(dir){
			case 'R':
				x+=step;dir='U';break;
			case 'U':
				y=y+step; dir ='L'; break;
			case 'L':
				x = x - step; dir ='D'; break;
			case 'D':
				y = y -step; dir = 'r'; break; // r - 5th turn
			case 'r':
				x = x + step; dir = 'R';
		}
		step+=10;
